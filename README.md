...
**NOTA: Dentro del código de esta guía, se pueden ver algunas de las herramientas estadísticas usadas en este código con fines académicos.**
**En Internet exiaten muchos ejemplos de este dataset tan conocido (recordamos que en nuestro caso lo hemos descargado de [Kaggle](https://www.kaggle.com) cumpliendo con sus requisitos).**
